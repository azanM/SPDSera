                ...
                <div style="border: 1px solid #e3e3e3">
                    <asp:GridView ID="gvGA" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="isCompletedGA" HeaderText="isCompletedGA" HeaderStyle-CssClass="hideIt" ItemStyle-CssClass="hideIt" ReadOnly="True" SortExpression="isCompletedGA" />
                            ...
                            <asp:TemplateField ItemStyle-CssClass="fright" ControlStyle-Width="60" ItemStyle-Width="130">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnComplete" runat="server" Font-Size="8"
                                        CommandName="Complete" Visible="true"
                                        CommandArgument='<%# Eval("noSPD") %>'
                                        Text="Complete" />
                                    <asp:Button ID="btnExpired" runat="server" Font-Size="8"
                                         CommandName="disableExpired" Visible="false"
                                         CommandArgument='<%# Eval("noSPD") %>'
                                         Text="UnExpired"/>
                                </ItemTemplate>
                            </asp:TemplateField>
