    ...
    public partial class frmRequestInput : System.Web.UI.Page
    {
        ...
        public bool ApprovalInsert(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                listAppS.Insert(0, approvalADH);
                // set first index level for claim email
                var atasanPertama = listAppS.OrderBy(o => o.IndexLevel.Value == 0).FirstOrDefault();
        ...
        {
            string costCenter = txtCostCenter.SelectedValue;
                            ...
                            try
                            {
                                ...
                                if (approvalMethod)
                                {
                                    ...
                                    spd.status = "Menunggu Approval " + datas
                                        .ApprovalStatus
                                        .FirstOrDefault(o => o.NoSPD == spd.noSPD && o.IndexLevel == 0)
                                    ...
                                    EmailCore.ApprovalSPD(nrpAtasanFirst.Value, "0", spd,null);
