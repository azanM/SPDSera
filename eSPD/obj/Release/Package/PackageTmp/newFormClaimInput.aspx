                    ...
                    <div class="panel-body">
                        <table class="gridtable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><asp:label ID="label1" runat="server">Tunjangan Kejauhan 1</asp:label>
                                        &nbsp;(
                                        <asp:Label ID="lblTunjanganKejauhan" runat="server"></asp:Label>
                                        /Hari X
                                        <asp:Label ID="lblHariTunjKejauhan" runat="server"></asp:Label>)
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td><asp:Label ID="label2" runat="server">Tunjangan Kejauhan 2</asp:Label>
                                        &nbsp;(
                                        <asp:Label ID="lblTunjanganKejauhan2" runat="server"></asp:Label>
                                        /Hari X
                                        <asp:Label ID="lblHariTunjKejauhan2" runat="server"></asp:Label>)
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTunjanganKejauhan2" runat="server" OnTextChanged="GeneralFunction"
                                            AutoPostBack="True" ReadOnly="true">0</asp:TextBox>
                                        <asp:TextBox ID="Tunjangankejauhan2" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="label3" runat="server">Tunjangan Kejauhan 3</asp:Label>
                                        &nbsp;(
                                        <asp:Label ID="lblTunjanganKejauhan3" runat="server"></asp:Label>
                                        /Hari X
                                        <asp:Label ID="lblHariTunjKejauhan3" runat="server"></asp:Label>)
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTunjanganKejauhan3" runat="server" OnTextChanged="GeneralFunction"
                                            AutoPostBack="True" ReadOnly="true">0</asp:TextBox>
                                        <asp:TextBox ID="Tunjangankejauhan3" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="label4" runat="server"> Tunjangan Kejauhan 4</asp:Label>
                                        &nbsp;(
                                        <asp:Label ID="lblTunjanganKejauhan4" runat="server"></asp:Label>
                                        /Hari X
                                        <asp:Label ID="lblHariTunjKejauhan4" runat="server"></asp:Label>)
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTunjanganKejauhan4" runat="server" OnTextChanged="GeneralFunction"
                                            AutoPostBack="True" ReadOnly="true">0</asp:TextBox>
                                        <asp:TextBox ID="Tunjangankejauhan4" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="label5" runat="server"> Tunjangan Kejauhan 5</asp:Label>
                                        &nbsp;(
                                        <asp:Label ID="lblTunjanganKejauhan5" runat="server"></asp:Label>
                                        /Hari X
                                        <asp:Label ID="lblHariTunjKejauhan5" runat="server"></asp:Label>)
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTunjanganKejauhan5" runat="server" OnTextChanged="GeneralFunction"
                                            AutoPostBack="True" ReadOnly="true">0</asp:TextBox>
                                        <asp:TextBox ID="Tunjangankejauhan5" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtKomunikasi" runat="server" OnTextChanged="GeneralFunction" ReadOnly="true"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdatePanel runat="server" ID="updatepanel1">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload ID="fuDoc" runat="server" Enabled="true" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <asp:UpdatePanel runat="server" ID="updatepanel2">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload ID="fuDoc1" runat="server" Enabled="true" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
