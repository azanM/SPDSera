                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvMasterHardship" runat="server" AutoGenerateColumns="False" CellPadding="5"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:ImageButton ImageUrl="Style/icons8-edit-20.png" ID="lbEdit" runat="server" OnClick="lbEdit_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:imageButton ImageUrl="Style/icons8-cancel-20.png" ID="lbDelete" runat="server" 
                                            OnClick="lbDelete_Click" 
                                            OnClientClick ="if (!confirm('Are you sure?')) {return false;} else {return true;}"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
