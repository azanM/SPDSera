            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <asp:DropDownList ID="ddlPosisi"
                        ...
                        <asp:ListItem Text="Direksi SBU" Value="Direksi SBU"></asp:ListItem>
                        ...
                        <asp:ListItem Text="Presiden Director Sera" Value="Presiden Director"></asp:ListItem>
                        <asp:ListItem Text="Presiden Director SBU" Value="Presiden Director SBU"></asp:ListItem>
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <dd>
                    ...
                    <asp:LinqDataSource
                        ID="LinqCabang" EnableViewState="true"
                        runat="server"
                        ContextTypeName="eSPD.dsSPDDataContext"
                        EntityTypeName=""
                        GroupBy="kodePA"
                ...
                <dd>
                    ...
                    <asp:DropDownList
                        ID="ddlPSubAreaTujuan" AppendDataBoundItems="true"
                        runat="server"
                    ...
                    <asp:LinqDataSource
                        ...
                        OrderGroupsBy="key"
                        Select="new (PersonalAreaCode, Code, Name)"
                        TableName="view_personnel_sub_area" Where="PersonalAreaCode == @kodePA">
                        <WhereParameters>
                ...
                <dd>
                    <asp:TextBox
                        ID="txtTglBerangkat" runat="server" onKeydown="return false;"
...
<%--                        <asp:ListItem>24</asp:ListItem>--%>
                ...
                <dd>
                    <asp:TextBox ID="txtTglExp" CssClass="calenderJQ" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                </dd>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <asp:DropDownList
                        ID="ddlCostCenter"
                        runat="server"
                        OnSelectedIndexChanged="CostCenter_OnSelectedIndexChanged"
                        AutoPostBack="true"
                    ...
                    <asp:LinqDataSource
                        ...
                        ContextTypeName="eSPD.dsSPDDataContext"
                        EntityTypeName=""
                        Select="new (costId, costDesc)" TableName="msCosts" Where="!costDesc.Contains(@costDesc)">
                        <WhereParameters>
                            <asp:ControlParameter ControlID="ddlCostCenter" Name="costDesc" DefaultValue="EMCO" Type="String" />
                        </WhereParameters>
                    </asp:LinqDataSource>
                    <asp:RequiredFieldValidator
                        ID="rvCostCenter"
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <dt>Tipe Pesawat</dt>
                <dd>
                    <asp:DropDownList ID="ddlTipePesawat" runat="server" Enabled="false">
                        <asp:ListItem Text=" - Select One -" Value=""></asp:ListItem>
                        <asp:ListItem Value="Garuda">Garuda</asp:ListItem>
                        <asp:ListItem Value="NonGaruda">NonGaruda</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator 
                        ID="rvTipePesawat" 
                        runat="server" ErrorMessage="Harus dipilih" 
                        SetFocusOnError="true" 
                        Font-Bold="true" 
                        ControlToValidate="ddlTipePesawat">
                    </asp:RequiredFieldValidator>
                </dd>
                <dt>Kota Asal</dt>
                <dd>
                    <asp:DropDownList ID="ddlKotaAsal"
                        runat="server"
                        CssClass="kotaTujuan" AppendDataBoundItems="true">
                        <asp:ListItem Text=" - Select One -" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    &nbsp; Kota Tujuan
                    <asp:DropDownList ID="ddlKotaTujuan" AutoPostBack="true"
                        runat="server" OnSelectedIndexChanged="ddlKotaTujuan_OnSelectedIndexChanged"
                        CssClass="kotaTujuan" AppendDataBoundItems="true">
                        <asp:ListItem Text=" - Select One -" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                </dd>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <dd>
                    <ul>
                    <asp:Label ID="labelMessageHari" runat="server" Visible="false">
                        <li><b>Total jumlah hari harus sama dengan total hari lama SPD</b> </li>
                    </asp:Label>
                    </ul>
                </dd>
                ...
                <dt></dt>
                <dd>
                    <asp:Panel ID="panelTunjanganHardship" runat="server">
                        <asp:GridView ID="gvTunjanganHarship" runat="server" CssClass="gridtable" ShowFooter="true"
                            AutoGenerateColumns="false" OnRowCreated="gvTunjanganHarship_RowCreated" OnRowDataBound="gvTunjanganHarship_RowDataBound" >
                            <Columns>
                                <asp:BoundField DataField="RowNumber" HeaderText="No" />
                                <asp:TemplateField HeaderText="Lokasi">
                                    <ItemTemplate>
                                        <asp:DropDownList Width="180px" ID="listLokasi1" CssClass="Lokasi" AutoPostBack="true"
                                            runat="server" OnSelectedIndexChanged="listLokasi1_SelectedIndexChanged"
                                            DataValueField="Id" DataTextField="Lokasi" 
                                            AppendDataBoundItems="true">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                       
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Hardship" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:TextBox  Width="80px" CssClass="Lokasi" ID="harga1" runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="JumlahHari" ItemStyle-Width="50px" >
                                    <ItemTemplate>
                                        <asp:TextBox Width="80px" ID="jumlahHari" runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterStyle HorizontalAlign="Right" />
                                    <FooterTemplate>
                                        <asp:Button ID="ButtonAddLokasi" runat="server" Text="Tambah Lokasi" CausesValidation="false" OnClick="ButtonAddLokasi_Click" />
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>  
                                    <ItemTemplate>  
                                        <asp:LinkButton ID="LinkRemove" CausesValidation="false" OnClick="LinkRemove_Click" runat="server">Delete</asp:LinkButton>  
                                    </ItemTemplate>  
                                </asp:TemplateField>  
                            </Columns>
                        </asp:GridView>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        ErrorMessage="Approval ADH tidak ditemukan"
                        Font-Bold="True"
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                </dd>
    ...
    <div class="panel panel-default">
        ...
        <asp:Panel ID="pnlError" class="panel-body" Visible="false" runat="server">
            <div class="panel-body">
                <div class="bs-callout bs-callout-danger">
                    <h4>SPD Gagal disave
                        <asp:Label ID="lblGagagl" runat="server" Text="">
                        </asp:Label>
                    </h4>
                    <ul>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("select:not(.time,.pesawat, .kotaTujuan, .Lokasi, .tes)").select2({
