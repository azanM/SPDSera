...
namespace eSPD
{
    public partial class frmSPDFinder : System.Web.UI.Page
    {
        ...
        private void DetailClicks(object sender)
        {
            ...
            GridViewRow gv = (GridViewRow)(link.NamingContainer);
            string strNoSpd = gv.Cells[0].Text;
            //Session["noSPD"] = strNoSpd; 2019-04-02
            //Response.Redirect("frmRequestInput.aspx"); 2019-04-02
            Response.Redirect("newFormRequestInput.aspx?noSPD=" + strNoSpd + "&Action=EditADH", true);
        }
