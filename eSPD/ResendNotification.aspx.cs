                ...
                if (dataSpd != null && approval != null)
                {
                    switch (dataSpd.isApproved)
                    {
                        case null:
                            ...
                            {
                                // proses approval tujuan
                                EmailCore.ApprovalSPD(dataSpd.nrpApprovalTujuan, string.Empty, dataSpd,null);
                            ...
                            else
                            {
                                // proses next approval
                                var currentApproval = approval.FirstOrDefault(o => o.Status == null);
                                EmailCore.ApprovalSPD(currentApproval.NrpApproval, currentApproval.IndexLevel.ToString(), dataSpd,null);
                            }
