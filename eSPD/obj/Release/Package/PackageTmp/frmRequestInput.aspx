...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        <table style="width: 100%;" cellspacing="3px" celpadding="1px" border="0" class="mastertable">
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:DropDownList
                                    ID="txtCostCenter"
                                    runat="server" OnSelectedIndexChanged="CostCenter_OnSelectedIndexChanged" AutoPostBack="true"
            ...
            <tr>
                <td class="style9">Approval PIC Budget
                </td>
                <td align="left">
                    <table>
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label3" runat="server" ForeColor="#CC0000" Text="*"></asp:Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlApprovalADH"
                                            ErrorMessage="Harus Diisi" Font-Bold="True" SetFocusOnError="True" ValidationGroup="a"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                    </table>
