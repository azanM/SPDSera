    ...
    public partial class newFormClaimInput : System.Web.UI.Page
    {
        ...
        protected void GenerateContent(trSPD spd)
        {
            using (var ctx = new dsSPDDataContext())
            {
                ...
                txtTunjanganKejauhan.Text = "0";
                txtTunjanganKejauhan2.Text = "0";
                txtTunjanganKejauhan3.Text = "0";
                txtTunjanganKejauhan4.Text = "0";
                txtTunjanganKejauhan5.Text = "0";
                if (spd.idTunjanganKejauhan != null)
                {
                    SqlCommand cmd = new SqlCommand("Select Harga, Lokasi from Hardship where Id = " + spd.idTunjanganKejauhan + "", new SqlConnection(ConfigurationManager.AppSettings["SPDConnectionString1"]));
                    cmd.Connection.Open();
                    SqlDataReader Reader;
                    Reader = cmd.ExecuteReader();
                    while (Reader.Read())
                    {
                        label1.Text = label1.Text + "(" + Reader["Lokasi"].ToString() + ")";
                        if (spd.hariTunjangan1 != null)
                        {
                            lblHariTunjKejauhan.Text = spd.hariTunjangan1.ToString();
                            lblTunjanganKejauhan.Text = Reader["Harga"].ToString();
                            txtTunjanganKejauhan.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * spd.hariTunjangan1.Value).ToString() : "0";
                        }
                        else
                        {
                            lblHariTunjKejauhan.Text = lblJumlahHari.Text;
                            lblTunjanganKejauhan.Text = Reader["Harga"].ToString();
                            txtTunjanganKejauhan.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * Jumlahhari.Days).ToString() : "0";
                        }
                    }
                }
                if (spd.idTunjanganKejauhan2 != null && spd.hariTunjangan2 != null)
                {
                    SqlCommand cmd = new SqlCommand("Select Harga, Lokasi from Hardship where Id = " + spd.idTunjanganKejauhan2 + "", new SqlConnection(ConfigurationManager.AppSettings["SPDConnectionString1"]));
                    cmd.Connection.Open();
                    SqlDataReader Reader;
                    Reader = cmd.ExecuteReader();
                    while (Reader.Read())
                    {
                        lblTunjanganKejauhan2.Text = Reader["Harga"].ToString();
                        label2.Text = label2.Text + "(" + Reader["Lokasi"].ToString() + ")";
                        lblHariTunjKejauhan2.Text = spd.hariTunjangan2.ToString();
                        txtTunjanganKejauhan2.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * spd.hariTunjangan2.Value).ToString() : "0";
                    }
                }
                if (spd.idTunjanganKejauhan3 != null && spd.hariTunjangan3 != null)
                {
                    SqlCommand cmd = new SqlCommand("Select Harga, Lokasi from Hardship where Id = " + spd.idTunjanganKejauhan3 + "", new SqlConnection(ConfigurationManager.AppSettings["SPDConnectionString1"]));
                    cmd.Connection.Open();
                    SqlDataReader Reader;
                    Reader = cmd.ExecuteReader();
                    while (Reader.Read())
                    {
                        label3.Text = label3.Text + "(" + Reader["Lokasi"].ToString() + ")";
                        lblHariTunjKejauhan3.Text = spd.hariTunjangan3.ToString();
                        txtTunjanganKejauhan3.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * spd.hariTunjangan3.Value).ToString() : "0";
                    }
                }
                if (spd.idTunjanganKejauhan4 != null && spd.hariTunjangan4 != null)
                {
                    SqlCommand cmd = new SqlCommand("Select Harga, Lokasi from Hardship where Id = " + spd.idTunjanganKejauhan4 + "", new SqlConnection(ConfigurationManager.AppSettings["SPDConnectionString1"]));
                    cmd.Connection.Open();
                    SqlDataReader Reader;
                    Reader = cmd.ExecuteReader();
                    while (Reader.Read())
                    {
                        label4.Text = label4.Text + "(" + Reader["Lokasi"].ToString() + ")";
                        lblHariTunjKejauhan4.Text = spd.hariTunjangan4.ToString();
                        txtTunjanganKejauhan4.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * spd.hariTunjangan4.Value).ToString() : "0";
                    }
                }
                if (spd.idTunjanganKejauhan5 != null && spd.hariTunjangan5 != null)
                {
                    SqlCommand cmd = new SqlCommand("Select Harga, Lokasi from Hardship where Id = " + spd.idTunjanganKejauhan5 + "", new SqlConnection(ConfigurationManager.AppSettings["SPDConnectionString1"]));
                    cmd.Connection.Open();
                    SqlDataReader Reader;
                    Reader = cmd.ExecuteReader();
                    while (Reader.Read())
                    {
                        label5.Text = label5.Text + "(" + Reader["Lokasi"].ToString() + ")";
                        lblHariTunjKejauhan5.Text = spd.hariTunjangan5.ToString();
                        txtTunjanganKejauhan5.Text = Reader["Harga"] != null ? (int.Parse(Reader["Harga"].ToString()) * spd.hariTunjangan5.Value).ToString() : "0";
                    }
                }
                ...
                if (ifga(karyawan.nrp))
                {
                    ...
                    cbKomunikasi.Visible = false;//per 2019 ditutup
                    ...
                    txtTunjanganKejauhan2.ReadOnly = false;
                    txtTunjanganKejauhan2.Enabled = true;

                    txtTunjanganKejauhan3.ReadOnly = false;
                    txtTunjanganKejauhan3.Enabled = true;

                    txtTunjanganKejauhan4.ReadOnly = false;
                    txtTunjanganKejauhan4.Enabled = true;

                    txtTunjanganKejauhan5.ReadOnly = false;
                    txtTunjanganKejauhan5.Enabled = true;
        ...
        private void BindClaim(trClaim claim)
        {
            if (isLuarNegeri.Checked)
            {
                ...
                txtTunjanganKejauhan2.Text = claim.UangTunjanganKejauhan2.ToString();
                txtTunjanganKejauhan3.Text = claim.UangTunjanganKejauhan3.ToString();
                txtTunjanganKejauhan4.Text = claim.UangTunjanganKejauhan4.ToString();
                txtTunjanganKejauhan5.Text = claim.UangTunjanganKejauhan5.ToString();
        ...
        protected void HideResult(bool p)
        {
            ...
            Tunjangankejauhan.Visible = p;
            Tunjangankejauhan2.Visible = p;
            Tunjangankejauhan3.Visible = p;
            Tunjangankejauhan4.Visible = p;
            Tunjangankejauhan5.Visible = p;
        }
        ...
        protected void GeneralFunction(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(txtTunjanganKejauhan2.Text)) txtTunjanganKejauhan2.Text = "0";
            if (String.IsNullOrEmpty(txtTunjanganKejauhan3.Text)) txtTunjanganKejauhan3.Text = "0";
            if (String.IsNullOrEmpty(txtTunjanganKejauhan4.Text)) txtTunjanganKejauhan4.Text = "0";
            if (String.IsNullOrEmpty(txtTunjanganKejauhan5.Text)) txtTunjanganKejauhan5.Text = "0";
            ...
            var tunjanganKejauhan2 = Convert.ToInt32(txtTunjanganKejauhan2.Text);
            var tunjanganKejauhan3 = Convert.ToInt32(txtTunjanganKejauhan3.Text);
            var tunjanganKejauhan4 = Convert.ToInt32(txtTunjanganKejauhan4.Text);
            var tunjanganKejauhan5 = Convert.ToInt32(txtTunjanganKejauhan5.Text);
            var total =
                uangMakan +
                uangSaku +
                tiket +
            ...
            Tunjangankejauhan.Text = (tunjanganKejauhan * kursInt).ToString();
            Tunjangankejauhan2.Text = (tunjanganKejauhan * kursInt).ToString();
            Tunjangankejauhan3.Text = (tunjanganKejauhan * kursInt).ToString();
            Tunjangankejauhan4.Text = (tunjanganKejauhan * kursInt).ToString();
            Tunjangankejauhan5.Text = (tunjanganKejauhan * kursInt).ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            using (var ctx = new dsSPDDataContext())
            {
                ...
                var tunjanganKejauhan2 = Convert.ToInt32(Tunjangankejauhan2.Text);
                var tunjanganKejauhan3 = Convert.ToInt32(Tunjangankejauhan3.Text);
                var tunjanganKejauhan4 = Convert.ToInt32(Tunjangankejauhan4.Text);
                var tunjanganKejauhan5 = Convert.ToInt32(Tunjangankejauhan5.Text);
                ...
                claim.UangTunjanganKejauhan2 = tunjanganKejauhan2;
                claim.UangTunjanganKejauhan3 = tunjanganKejauhan3;
                claim.UangTunjanganKejauhan4 = tunjanganKejauhan4;
                claim.UangTunjanganKejauhan5 = tunjanganKejauhan5;
                ...
                claim.uangSaku_cek = cbUangSaku.Checked;//penambahan A
                claim.hotelTanpaPenginapan_cek = cbHotelTanpaPenginapan.Checked;//penambahan A
                ...
                finally
                {
                    ...
                    if (ifga(karyawan.nrp))
                    {
                        if (claim.tiket_cek == true || claim.hotel_cek == true || claim.laundry_cek == true || claim.komunikasi_cek == true || claim.airportTax_cek == true || claim.BBM_cek == true || claim.tol_cek == true || claim.taxi_cek == true || claim.parkir_cek == true || claim.uangSaku_cek == true || claim.hotelTanpaPenginapan_cek == true)
                        {
        ...
        protected void cbBiayaHotel_OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            if (cBox.Checked)
            {
                cbHotelTanpaPenginapan.Checked = false;
            }
            else
            {
