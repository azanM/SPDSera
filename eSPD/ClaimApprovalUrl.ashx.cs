                ...
                try
                {
                    ...
                    if (dataClaim != null && dataSpd != null)
                    {
                                ...
                                case "ga":
                                    ...
                                    var query = (from a in dc.trClaims
                                                 ...
                                                 select new
                                                 {
                                                     ...
                                                     UangMuka = b.uangMuka,
                                                     TunjanganKejauhan = a.UangTunjanganKejauhan,
                                                     TunjanganKejauhan2 = a.UangTunjanganKejauhan2,
                                                     TunjanganKejauhan3 = a.UangTunjanganKejauhan3,
                                                     TunjanganKejauhan4 = a.UangTunjanganKejauhan4,
                                                     TunjanganKejauhan5 = a.UangTunjanganKejauhan5,
                                    ...
                                    int TotalTunjanganKejauhan =  query.TunjanganKejauhan != null ? query.TunjanganKejauhan.Value : 0 +
                                                                  query.TunjanganKejauhan2 != null ? query.TunjanganKejauhan2.Value : 0 +
                                                                  query.TunjanganKejauhan3 != null ? query.TunjanganKejauhan3.Value : 0 +
                                                                  query.TunjanganKejauhan4 != null ? query.TunjanganKejauhan4.Value : 0 +
                                                                  query.TunjanganKejauhan5 != null ? query.TunjanganKejauhan5.Value : 0;
                                    ...
                                    message += TotalTunjanganKejauhan;

                                    //message += query.TunjanganKejauhan != null ? query.TunjanganKejauhan : 0;
                                    ...
                                    DataSet ds = helper.wsEmail("claim");
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        DataRow drCheckBcc = ds.Tables[0].Rows[0];
                                        DataView dvCheckBcc = new DataView(ds.Tables[0]);
                                        for (int i = 0; i < dvCheckBcc.Count; i++)
                                        {
                                            string nrpGA = drCheckBcc.Table.Rows[i][1].ToString();
                                            EmailCore.InformasiClaim(nrpGA, dataClaim.noSPD, dataSpd, dataClaim.status);
                                        }
                                    }
                                    EmailCore.InformasiClaim(dataSpd.dibuatOleh, dataClaim.noSPD, dataSpd, dataClaim.status);
                        ...
                        else if(action.ToLower().Contains("complete"))
                        {
                            ...
                            {
                                case "ga":
                                    msUser kepalaGA = ctx.msUsers.Where(x => x.roleId == 297).FirstOrDefault();                                    
                                    dataClaim.isCompletedGA = true;
                                    ctx.SubmitChanges();
                                    EmailCore.ApprovalClaim(kepalaGA.nrp, dataClaim.noSPD, dataSpd, "ga", dataClaim.status);
                                    return nospd + " berhasil di Complete";
                                default:
                                    break;
                            }
                        }

                        else if (action.ToLower().Contains("disableExpired"))
                        {
                            switch (claimapprove.ToLower())
                            {
                                case "ga":
